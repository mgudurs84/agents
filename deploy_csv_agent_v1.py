...
def deploy_with_agent_engines(agent):
    ...
    try:
        ...
        print("Vertex AI initialized with gcloud credentials")
...
def main():
    ...
    print("Step 4: Setting up environment...")
    ...
    # Step 7: Deploy (try agent engines first, fallback to reasoning engines)
    deployed_agent = None
